...
#define L298N_in4 7  // Dir Motor B
#define L298N_in3 8  // Dir Motor B
...
void loop() {
  ...
  {
    right_wheel_meas_vel = (10 * right_encoder_counter * (60.0/850.0)) * 0.10472;
    left_wheel_meas_vel = (10 * left_encoder_counter * (60.0/850.0)) * 0.10472;
