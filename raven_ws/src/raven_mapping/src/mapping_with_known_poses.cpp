...
#include "raven_mapping/mapping_with_known_poses.hpp"
    ...
    : Node(name)
{
    ...
    scan_sub_ = create_subscription<sensor_msgs::msg::LaserScan>(
        "scan", 100, std::bind(&MappingWithKnownPoses::scanCallback, this, _1));
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<raven_mapping::MappingWithKnownPoses>("mapping_with_known_poses");
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
