#include "raven_controller/simple_controller.hpp"
...
SimpleController::SimpleController(const std::string& name)
                                  ...
                                  , theta_(0.0)
{
    declare_parameter("wheel_radius", 0.0205);
    declare_parameter("wheel_separation", 0.155);
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/raven_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/raven_controller/odom", 10);
