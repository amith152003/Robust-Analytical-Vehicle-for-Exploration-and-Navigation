...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("wheel_radius", 0.0205)
        ...
        self.vel_sub_ = self.create_subscription(Twist, "raven_controller/cmd_vel_unstamped", self.velCallback, 10)
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointCallback, 10)        
        self.odom_pub_ = self.create_publisher(Odometry, "raven_controller/odom", 10)
